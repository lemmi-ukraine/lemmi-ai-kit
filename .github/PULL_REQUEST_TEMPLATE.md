...
- [ ] Registered in `src/lemmi_ai_kit/assets/manifest.toml` with `name`, `profile`, `invocation`, `summary`
- [ ] `profile` is a value that exists in `PROFILES` in `src/lemmi_ai_kit/manifest.py`
