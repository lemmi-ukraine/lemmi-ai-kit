...
|---|---|---|---|---|---|
| PF-01 | main | an ineligible session is evaluated | `IdlePolicy.evaluate` → `IdlePolicy.is_eligible` → `IdlePolicy._reset` | PASS | `code: src/policy.py reads state defined in src/state.py` |
