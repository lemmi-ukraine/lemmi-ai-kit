# Flow — Runtime-reference validator fixture (PF)
...
|---|---|---|---|---|
| fixture | `warn_threshold_seconds=15`, `end_threshold_seconds=0` | `_none_` | `_none_` | `code: src/policy.py branches on the effective thresholds` |
