# Lemmi AI Kit Orchestration

Delegation, initiative coordination, branch reviews and stacked-work workflows. Requires core.

Install `lemmi-ai-kit-orchestration@lemmi` with the host plugin manager. Skills are
