...
- `lemmi-ai-kit-core:plan-critic (references/dor-tables.md)`
- `lemmi-ai-kit-core:plan-critic (references/review-dimensions.md)`
- `lemmi-ai-kit-core:plan-critic (references/finding-format.md)`
