...
| Authored by | **`/lemmi-ai-kit-core:product-brief`**, then add §A below | this template, §A + §C |
...
**The bar for both shapes** is `/lemmi-ai-kit-core:product-brief`'s Dimension 1 (Problem Strength): *falsifiable,
...
`/lemmi-ai-kit-core:product-brief` does **not** emit three of these — its template is Problem · Behavior · UX Content ·
...
Owned by `/lemmi-ai-kit-core:product-brief` — Problem · Behavior · **UX Content** · Out of Scope · Implementation
