...
# Scout Review — notice cheaply, verify expensively, report rarely — [pack prerequisites](../../README.md)
...
```
/lemmi-ai-kit-orchestration:scout-review                 # default combo: sonnet scout + fable deep reviewers
/lemmi-ai-kit-orchestration:scout-review opus            # combo B: sonnet scout + opus deep reviewers
/lemmi-ai-kit-orchestration:scout-review fable base=main # review current branch against main
/lemmi-ai-kit-orchestration:scout-review opus <PR-url>   # review a PR (fetch the diff via `gh pr diff`)
/lemmi-ai-kit-orchestration:scout-review scout=haiku reviewer=opus   # explicit override for experiments
```
