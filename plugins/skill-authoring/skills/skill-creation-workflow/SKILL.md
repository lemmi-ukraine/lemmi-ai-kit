...
# Skill Creation Workflow — Research-Backed Pipeline — [pack prerequisites](../../README.md)
...
- User invokes `/lemmi-ai-kit-skill-authoring:skill-creation-workflow`

**When to use this vs `/lemmi-ai-kit-skill-authoring:skill-creator` directly:**
...
- Use `/lemmi-ai-kit-skill-authoring:skill-creator` directly when the topic is well-understood and doesn't
...
- **Never skip research**: The research phase is what differentiates this workflow from
  direct `/lemmi-ai-kit-skill-authoring:skill-creator` invocation — if you skip it, the user should use `/lemmi-ai-kit-skill-authoring:skill-creator`
