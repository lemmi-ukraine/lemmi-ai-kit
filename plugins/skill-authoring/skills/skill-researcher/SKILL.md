...
# Skill Researcher — Domain & Problem-Solving Research — [pack prerequisites](../../README.md)
...
- Gate each candidate source for RELEVANCE before analyzing it; prefer a few authoritative
  ...
  explicitly.
- Apply SIFT lateral reading when authority is unclear: stop, investigate the source,
  find better coverage, and trace claims to their origin. The research plugin's planner
  offers a fuller protocol when installed; it is not a prerequisite for this check.
