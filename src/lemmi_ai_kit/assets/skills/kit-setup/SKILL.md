...
- `/lemmi-ai-kit:kit-setup` — first-time seed (or complete missing files).
- `/lemmi-ai-kit:kit-setup refresh` — re-detect and update ONLY the marked
...
CLAUDE.md skill catalog (`/lemmi-ai-kit:<name>` invocations) and stamps
provenance.
